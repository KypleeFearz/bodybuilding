var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 60, 12, 1535);
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 61, 12, 1605);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$3, 59, 8, 1504);
    			attr_dev(div1, "class", "row mb-3");
    			add_location(div1, file$3, 58, 4, 1472);
    			attr_dev(label1, "class", "form-label");
    			attr_dev(label1, "for", "email");
    			add_location(label1, file$3, 71, 12, 1862);
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "email");
    			attr_dev(input1, "type", "email");
    			add_location(input1, file$3, 72, 12, 1928);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file$3, 70, 8, 1831);
    			attr_dev(div3, "class", "row mb-3");
    			add_location(div3, file$3, 69, 4, 1799);
    			attr_dev(label2, "class", "form-label");
    			attr_dev(label2, "for", "age");
    			add_location(label2, file$3, 82, 12, 2188);
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "id", "age");
    			attr_dev(input2, "type", "number");
    			add_location(input2, file$3, 83, 12, 2249);
    			attr_dev(div4, "class", "col");
    			add_location(div4, file$3, 81, 8, 2157);
    			attr_dev(div5, "class", "row mb-3");
    			add_location(div5, file$3, 80, 4, 2125);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$3, 91, 4, 2443);
    			attr_dev(form, "class", "mb-5");
    			add_location(form, file$3, 57, 0, 1447);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(td0, file$3, 107, 16, 2848);
    			add_location(td1, file$3, 108, 16, 2886);
    			add_location(tr, file$3, 106, 12, 2826);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$3, 55, 0, 1329);
    			add_location(h11, file$3, 95, 0, 2546);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$3, 99, 12, 2628);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$3, 100, 12, 2667);
    			add_location(tr, file$3, 98, 8, 2610);
    			add_location(thead, file$3, 97, 4, 2593);
    			add_location(tbody, file$3, 104, 4, 2774);
    			attr_dev(table, "class", "table");
    			add_location(table, file$3, 96, 0, 2566);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src\\pages\\Forum.svelte";
    ...
    const file$1 = "src\\pages\\Training.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(td0, file$1, 106, 16, 2855);
    			add_location(td1, file$1, 107, 16, 2898);
    			add_location(td2, file$1, 108, 16, 2940);
    			add_location(tr, file$1, 105, 12, 2833);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "mt-3");
    			add_location(h10, file$1, 56, 0, 1379);
    			attr_dev(label0, "class", "form-label");
    			attr_dev(label0, "for", "ubung");
    			add_location(label0, file$1, 60, 12, 1506);
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "ubung");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$1, 61, 12, 1571);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$1, 59, 8, 1475);
    			attr_dev(div1, "class", "row mb-3");
    			add_location(div1, file$1, 58, 4, 1443);
    			attr_dev(label1, "class", "form-label");
    			attr_dev(label1, "for", "satz");
    			add_location(label1, file$1, 71, 12, 1830);
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "satz");
    			attr_dev(input1, "type", "number");
    			add_location(input1, file$1, 72, 12, 1893);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file$1, 70, 8, 1799);
    			attr_dev(div3, "class", "row mb-3");
    			add_location(div3, file$1, 69, 4, 1767);
    			attr_dev(label2, "class", "form-label");
    			attr_dev(label2, "for", "wiederholung");
    			add_location(label2, file$1, 82, 12, 2152);
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "id", "wiederholung");
    			attr_dev(input2, "type", "age");
    			add_location(input2, file$1, 83, 12, 2231);
    			attr_dev(div4, "class", "col");
    			add_location(div4, file$1, 81, 8, 2121);
    			attr_dev(div5, "class", "row mb-3");
    			add_location(div5, file$1, 80, 4, 2089);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$1, 91, 4, 2440);
    			attr_dev(form, "class", "mb-5");
    			add_location(form, file$1, 57, 0, 1418);
    			add_location(h11, file$1, 94, 0, 2540);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$1, 98, 12, 2626);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$1, 99, 12, 2666);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$1, 100, 12, 2705);
    			add_location(tr, file$1, 97, 8, 2608);
    			add_location(thead, file$1, 96, 4, 2591);
    			add_location(tbody, file$1, 103, 4, 2773);
    			attr_dev(table, "class", "table");
    			add_location(table, file$1, 95, 0, 2564);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Training> was created with unknown prop '${key}'`);
    	});
